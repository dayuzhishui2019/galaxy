...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  i32 upload(IotInfo data)")
  fmt.Fprintln(os.Stderr, "  i32 batchUpload( datas)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  case "upload":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Upload requires 1 args")
      flag.Usage()
    }
    arg7 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.Upload(context.Background(), value0))
    fmt.Print("\n")
    break
  case "batchUpload":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "BatchUpload requires 1 args")
      flag.Usage()
    }
    arg13 := flag.Arg(1)
    ...
    containerStruct0 := shared.NewDAGThriftServiceBatchUploadArgs()
    err18 := containerStruct0.ReadField1(jsProt17)
    if err18 != nil {
      Usage()
      return
    }
    argvalue0 := containerStruct0.Datas
    value0 := argvalue0
    fmt.Print(client.BatchUpload(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
